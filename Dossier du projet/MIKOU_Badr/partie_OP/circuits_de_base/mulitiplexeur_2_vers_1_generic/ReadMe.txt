...
--		             	     Filiere :GSEII					--
--**************************************************************************************--
	-- Title	: ReadMe : multiplexeur 2 vers 1 generique
...
--**************************************************************************************--
    ...
    Vous trouver dans ce dossier l' architecture du cercuit d'un multiplexeur 2 vers 1 qui 
est une architecture de base dans divers cercuit electronique. Ce multiplexeur est composé
de 3 entrées et une sortie :
		- "in0" et "in1" des données generics.
